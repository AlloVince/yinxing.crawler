...
class ThzSpider(BaseSpider):
    ...
    rules = (
        Rule(LinkExtractor(allow=r'forum-(181|220|182|69|203|177)-(1|2|3|4)\.html', ), follow=True),
        Rule(LinkExtractor(allow=r'thread-\d+-1-\d+.html', ), follow=True, callback='handle_page'),
    )

    deep_rules = (
        Rule(LinkExtractor(allow=r'forum-(181|220|182|69|203|177)-\d+\.html', ), follow=True),
        Rule(LinkExtractor(allow=r'thread-\d+-1-\d+.html', ), follow=True, callback='handle_page'),
    )
