...
class SexinsexSpider(BaseSpider):
    ...
    rules = (
        Rule(
            # LinkExtractor(allow=r'forum-(318|143|230|229|122|463|25|58|77)-\d+\.html', ),
            LinkExtractor(allow=r'forum-(318|143|230|229|122|463|25|58|77)-(1|2|3|4|5|6|7|8|9)\.html', ),
            follow=True
        ),
